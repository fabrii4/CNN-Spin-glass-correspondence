...
#outputs
output_layer = Dense(n_hidden, use_bias=False, activation=LeakyReLU(alpha=0.1))(input_layer)
output_layer = Dense(n_out, use_bias=False, activation=LeakyReLU(alpha=0.1))(output_layer)
